...
def test_the_old_names_still_curated_are_known() -> None:
    """Every model the old list offered except SDXL Turbo, whose licence does
    not allow commercial use: its file stays on disk, unrecognised."""
    records = adopt(
