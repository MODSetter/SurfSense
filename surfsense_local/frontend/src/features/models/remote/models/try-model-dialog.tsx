...
function messageFrom(error: unknown) {
  return error instanceof Error
    ? error.message
    : intl.formatMessage({ id: "models_try_dialog_request_error" })
}
...
function Explanation({
  ...
  if (model.capability_source === "unknown") {
    return image
      ? intl.formatMessage({ id: "models_try_dialog_image_unconfirmed_body" })
      : intl.formatMessage({ id: "models_try_dialog_chat_unconfirmed_body" })
  }
  return image
    ? intl.formatMessage({ id: "models_try_dialog_image_confirmed_body" })
    : intl.formatMessage({ id: "models_try_dialog_chat_confirmed_body" })
}
    ...
    <>
        ...
        <DialogContent className="select-none">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={onClose}>
              {intl.formatMessage({ id: "models_try_dialog_cancel_button" })}
            </Button>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {intl.formatMessage({ id: "models_try_dialog_unlisted_title" })}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {confirmUnlisted ? `${confirmUnlisted} ` : ""}
              {intl.formatMessage({ id: "models_try_dialog_unlisted_body" })}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>
