...
| **Walmart** | Datos públicos de productos más el historial completo de reseñas: precios, calificaciones, vendedores y variantes | [Walmart Product & Review API](https://www.surfsense.com/walmart) |
...
|---------|-------------------|-----------|
| **Datos web en vivo para agentes** | No | Conectores de Reddit, YouTube, Instagram, TikTok, Amazon, Walmart, Google Maps, Google Search, Indeed y rastreo web vía API REST y MCP |
...
<a href="https://star-history.dera.page/#MODSetter/SurfSense&Date">
 <picture>
   ...
   <img alt="Star History Chart" src="https://star-history.dera.page/svg?repos=MODSetter/SurfSense&type=Date" />
 </picture>
</a>
