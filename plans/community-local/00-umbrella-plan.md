...
| **7** | catalog rework, fit badges, HF search (in [`api/07-llamacpp-runtime.md`](api/07-llamacpp-runtime.md)) | [`07-llamacpp-runtime.md`](api/07-llamacpp-runtime.md) — replace Ollama with llama.cpp | — |
| **8** | — | [`08-cuda-backend.md`](api/08-cuda-backend.md) — CUDA as an optional Windows backend. **Not scheduled**: measured at 0.66 s per turn for 685 MB | — |
