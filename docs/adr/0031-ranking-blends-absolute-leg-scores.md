...
- **Status:** Accepted; amended by [ADR 0032](0032-one-tokenizer-for-index-and-question.md), term coverage being safe only where a term is a word, and by [ADR 0033](0033-every-candidate-is-scored-on-its-own-cosine.md), a candidate missing from the vector leg being unmeasured rather than scoring zero
- **Date:** 2026-09-24
