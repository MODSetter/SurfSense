...
When an incident does occur, it is important to report it promptly. Email
`rohan@surfsense.com`. Do not post reports in public GitHub issues or Discord
channels.
...
spaces. For SurfSense that includes GitHub (issues, PRs, discussions),
Discord, and official email or social accounts. Examples of representing our
