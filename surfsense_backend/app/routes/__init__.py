...
from app.artifacts.generation.access.rest import build_artifact_router
...
router.include_router(build_artifact_router())  # Authenticated artifact generation (dev API)
