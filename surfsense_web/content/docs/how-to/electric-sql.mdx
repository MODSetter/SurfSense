...
Ensure your environment files are configured. If you haven't set up NeoNote yet, follow the [Manual Installation Guide](/docs/manual-installation) first.
...
GRANT CONNECT ON DATABASE neonote TO electric;
GRANT CREATE ON DATABASE neonote TO electric;
...
2. Delete databases starting with `neonote-`
