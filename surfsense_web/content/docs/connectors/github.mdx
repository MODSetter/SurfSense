---
title: GitHub
description: Connect your GitHub repositories to NeoNote
---

# GitHub Integration Setup Guide

This guide walks you through connecting your GitHub repositories to NeoNote for code search and AI-powered insights.
...
1. Go to [GitHub's token creation page](https://github.com/settings/tokens/new?description=neonote&scopes=repo) (pre-filled with `repo` scope)
2. Set an expiration
