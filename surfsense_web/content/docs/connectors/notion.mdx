---
title: Notion
description: Connect your Notion workspaces to NeoNote
---

# Notion OAuth Integration Setup Guide

This guide walks you through setting up a Notion OAuth integration for NeoNote.
...
Notion's API has limitations on certain block types that cannot be retrieved. NeoNote will automatically skip these unsupported blocks and continue syncing all other content.
...
## Running NeoNote with Notion Connector
