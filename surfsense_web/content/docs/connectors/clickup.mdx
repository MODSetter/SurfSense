---
title: ClickUp
description: Connect your ClickUp workspace to NeoNote
---

# ClickUp OAuth Integration Setup Guide

This guide walks you through setting up a ClickUp OAuth integration for NeoNote.
...
## Running NeoNote with ClickUp Connector
