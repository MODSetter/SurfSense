---
title: Jira
description: Connect your Jira projects to NeoNote
---

# Jira OAuth Integration Setup Guide

This guide walks you through setting up an Atlassian OAuth 2.0 (3LO) integration for NeoNote to connect your Jira projects.
...
## Running NeoNote with Jira Connector
