...
description: Connect your Microsoft Teams to NeoNote
---

# Microsoft Teams OAuth Integration Setup Guide

This guide walks you through setting up a Microsoft Teams OAuth integration for NeoNote using Azure App Registration.
...
4. Enter a description (e.g., `NeoNote`) and select an expiration period
5. Click **"Add"**
...
## Running NeoNote with Microsoft Teams Connector
