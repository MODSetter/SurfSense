---
title: Confluence
description: Connect your Confluence spaces to NeoNote
---

# Confluence OAuth Integration Setup Guide

This guide walks you through setting up an Atlassian OAuth 2.0 (3LO) integration for NeoNote to connect your Confluence spaces.
...
## Running NeoNote with Confluence Connector
