---
title: Obsidian
description: Connect your Obsidian vault to NeoNote
---

# Obsidian Integration Setup Guide

This guide walks you through connecting your Obsidian vault to NeoNote for note search and AI-powered insights.

<Callout type="warn">
    This connector requires direct file system access and only works with self-hosted NeoNote installations.
</Callout>
...
Add your vault as a volume mount to the NeoNote backend service:
...
- Check file permissions: NeoNote needs read access to the vault directory
