---
title: Slack
description: Connect your Slack workspace to NeoNote
---

# Slack OAuth Integration Setup Guide

This guide walks you through setting up a Slack OAuth integration for NeoNote.
...
## Running NeoNote with Slack Connector
