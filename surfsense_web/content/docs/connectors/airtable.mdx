---
title: Airtable
description: Connect your Airtable bases to NeoNote
---

# Airtable OAuth Integration Setup Guide

This guide walks you through setting up an Airtable OAuth integration for NeoNote.
...
The preview shows what users will see when authorizing NeoNote:
...
## Running NeoNote with Airtable Connector
