...
description: Connect your Google Calendar to NeoNote
---

# Google Calendar OAuth Integration Setup Guide

This guide walks you through setting up a Google OAuth 2.0 integration for NeoNote to connect your Google Calendar.
...
## Running NeoNote with Google Calendar Connector
