---
title: Gmail
description: Connect your Gmail to NeoNote
---

# Gmail OAuth Integration Setup Guide

This guide walks you through setting up a Google OAuth 2.0 integration for NeoNote to connect your Gmail account.
...
## Running NeoNote with Gmail Connector
