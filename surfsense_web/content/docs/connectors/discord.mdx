---
title: Discord
description: Connect your Discord servers to NeoNote
---

# Discord OAuth Integration Setup Guide

This guide walks you through setting up a Discord OAuth integration for NeoNote.
...
3. Enter the application name: `NeoNote`
4. Click **"Create"**
...
<Callout type="warn">
   Keep **Public Client** disabled (off) since NeoNote uses a server to make requests.
</Callout>
...
## Running NeoNote with Discord Connector
