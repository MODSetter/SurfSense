---
title: Linear
description: Connect your Linear workspace to NeoNote
---

# Linear OAuth Integration Setup Guide

This guide walks you through setting up a Linear OAuth integration for NeoNote.
...
| **Application name** | `NeoNote` |
| **Developer name** | `NeoNote` |
| **Developer URL** | `https://www.neonote.com/` |
...
## Running NeoNote with Linear Connector
