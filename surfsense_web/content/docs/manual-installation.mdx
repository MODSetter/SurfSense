...
description: Setting up NeoNote manually for customized deployments (Preferred)
icon: Wrench
---

# Manual Installation (Preferred)

This guide provides step-by-step instructions for setting up NeoNote without Docker. This approach gives you more control over the installation process and allows for customization of the environment.
...
The backend is the core of NeoNote. Follow these steps to set it up:
...
| LANGSMITH_PROJECT | LangSmith project name (e.g., `neonote`) |
...
The NeoNote browser extension allows you to save any webpage, including those protected behind authentication.
...
| ENV VARIABLE              | DESCRIPTION                                           |
| ------------------------- | ----------------------------------------------------- |
| PLASMO_PUBLIC_BACKEND_URL | NeoNote Backend URL (e.g., `http://127.0.0.1:8000`) |
...
Load the extension in your browser's developer mode and configure it with your NeoNote API key.
...
Now that you have NeoNote running locally, you can explore its features:
