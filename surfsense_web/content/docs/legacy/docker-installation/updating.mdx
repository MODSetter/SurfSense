...
Auto-updates every 24 hours. If you used the [install script](/docs/legacy/docker-installation) and enabled updates, Watchtower is already running — no extra setup needed.
