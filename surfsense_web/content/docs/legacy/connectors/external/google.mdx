...
<Callout type="info">
The redirect URIs below use `http://localhost:3929` — the default public URL of a Docker install. If you run SurfSense [manually](/docs/legacy/manual-installation), use your backend URL (`http://localhost:8000`); in production, use your public domain.
</Callout>
