...
<Cards>
  <Card
    ...
    href="/docs/legacy/connectors/external/google"
  />
  <Card
    title="Slack"
    description="Search and read channels and threads"
    href="/docs/legacy/connectors/external/slack"
  />
  <Card
    title="Airtable"
    description="Browse bases, tables, and records"
    href="/docs/legacy/connectors/external/airtable"
  />
  <Card
    title="Microsoft OneDrive"
    description="Import your OneDrive files into the knowledge base"
    href="/docs/legacy/connectors/external/onedrive"
  />
  <Card
    title="Dropbox"
    description="Import your Dropbox files into the knowledge base"
    href="/docs/legacy/connectors/external/dropbox"
  />
</Cards>
...
<Cards>
  ...
  <Card
    ...
    href="/docs/legacy/connectors/external/bookstack"
  />
  <Card
    title="Circleback"
    description="Receive meeting notes and transcripts via webhook"
    href="/docs/legacy/connectors/external/circleback"
  />
  <Card
    title="Obsidian"
    description="Sync your vault with the SurfSense Obsidian plugin"
    href="/docs/legacy/connectors/external/obsidian"
  />
</Cards>
