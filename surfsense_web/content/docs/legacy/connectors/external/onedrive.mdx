...
<Callout type="info">
`http://localhost:3929` is the default public URL of a Docker install. If you run SurfSense [manually](/docs/legacy/manual-installation), use your backend URL (`http://localhost:8000`); in production, use your public domain.
</Callout>
