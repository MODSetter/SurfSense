...
<Callout type="info">
  Microsoft Teams and [Microsoft OneDrive](/docs/legacy/connectors/external/onedrive) share the same Azure App Registration. If you have already created an app for OneDrive, you can reuse the same Client ID and Client Secret. Just make sure both redirect URIs are added (see Step 3).
</Callout>
...
Add the Microsoft OAuth credentials to your `.env` file (created during [Docker installation](/docs/legacy/docker-installation)):
