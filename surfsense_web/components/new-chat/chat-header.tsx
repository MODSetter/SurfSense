...
export function ChatHeader({ workspaceId, className, onChatModelSelected }: ChatHeaderProps) {
	const selectorClassName = cn(className, "min-w-0 flex-initial shrink sm:max-w-[180px]");

	return (
		<div className="flex min-w-0 flex-1 items-center justify-end gap-0 sm:max-w-[360px]">
			<ModelSelector
